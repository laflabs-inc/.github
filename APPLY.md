...
다음 문서를 기준으로 Repository를 생성하세요.

1. `docs/REPOSITORY_NAMING.md`
2. `docs/REPOSITORY_BASELINE.md`
3. `docs/ENGINEERING_NAMING_STANDARDS.md`

Repository 이름, Lifecycle, Description, Topics, Visibility를 함께 결정하는 것을 권장합니다.
